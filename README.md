...
├── db/
│   └── schema.sql          # fuente de verdad ejecutable del modelo de datos (14 tablas + 7 enums)
├── docs/
...
3. [`db/schema.sql`](./db/schema.sql) — esquema de base de datos ejecutable (fuente de verdad).
