...
RSpec.describe "Api::V1::LoyaltyRules", type: :request do
  ...
  describe "GET /api/v1/loyalty_rules/:id" do
    it "returns the loyalty rule" do
  ...
  describe "POST /api/v1/loyalty_rules" do
    it "creates a loyalty rule" do
      ...
      expect(LoyaltyRule.find(json_response["id"]).created_by).to eq(actor_id)
    end
  ...
  describe "PATCH /api/v1/loyalty_rules/:id" do
    it "updates the loyalty rule" do
      ...
      patch "/api/v1/loyalty_rules/#{loyalty_rule.id}", params: { loyalty_rule: { visits_required: 20 } }, headers: actor_headers
    ...
    it "returns 404 for a non-existent loyalty rule" do
      patch "/api/v1/loyalty_rules/999999", params: { loyalty_rule: { visits_required: 20 } }, headers: actor_headers
  ...
  describe "DELETE /api/v1/loyalty_rules/:id" do
    it "soft-deletes the loyalty rule" do
      ...
      delete "/api/v1/loyalty_rules/#{loyalty_rule.id}", headers: actor_headers
    ...
    it "returns 404 for a non-existent loyalty rule" do
      delete "/api/v1/loyalty_rules/999999", headers: actor_headers
